                                        ...
                                        <form id="editForm" action="<?= RUTA_URL ?>/perfil/actualizarPerfil"
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control editable"
                                                        value="<?= $usuario->apellido1Usuario ?>" name="apellido1Usuario" />
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control editable"
                                                        value="<?= $usuario->apellido2Usuario ?>" name="apellido2Usuario" />
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control editable"
                                                        value="<?= $usuario->telefonoUsuario ?>" name="telefonoUsuario" />
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        inputs.forEach(input => {
            ...
            input.addEventListener("input", () => {
                ...
                // Verificar si algún input fue modificado
                inputs.forEach(inp => {
